...
const AREA_GUIDANCE: Record<string, AreaGuide> = {
  ...
  "producción escrita": {
    queEvaluar: [
      "Estructura de oraciones (sujeto-verbo-objeto)",
      "Organización de ideas en secuencia lógica",
      "Ortografía frecuente y puntuación básica",
      "Legibilidad y grafomotricidad funcional",
    ],
    comoEvaluarlo: [
      "Producción espontánea de 3-4 oraciones a partir de una imagen",
      "Dictado de 10 palabras de alta frecuencia",
      "Copia de un párrafo breve: evaluar legibilidad y velocidad",
      "Completar un texto con huecos (inicio / desarrollo / cierre)",
    ],
    indicadoresClinicos: [
      "Oraciones incompletas o sin verbo de forma consistente",
      "Dificultad para organizar ideas en secuencia lógica",
      "Errores ortográficos frecuentes en palabras de uso cotidiano",
      "Texto ilegible o con tamaño de letra muy irregular",
    ],
    ejemploPractico: "Presentar una imagen de una escena cotidiana y pedir al paciente que escriba 3-4 oraciones describiendo lo que ve. Evaluar: estructura sintáctica, coherencia entre oraciones, ortografía y legibilidad. Comparar con una producción copiada del mismo volumen para separar dificultades ortográficas de grafomotrices.",
  },
  "memoria": {
    queEvaluar: [
      "Memoria de trabajo verbal (dígitos directos e inversos)",
      "Memoria episódica (recuerdo de contenido de sesiones previas)",
      "Retención de instrucciones (1, 2 y 3 pasos)",
      "Asociación imagen-palabra y memoria visual",
    ],
    comoEvaluarlo: [
      "Repetición de series de dígitos directos e inversos",
      "Recuerdo libre y con pistas de 5-7 imágenes presentadas brevemente",
      "Ejecutar 3 instrucciones en secuencia luego de un intervalo de actividad",
      "Matching de imágenes y palabras con período de observación y luego cubiertos",
    ],
    indicadoresClinicos: [
      "Span de dígitos directos inferior a 3 más allá de los 5 años",
      "No recuerda instrucciones de 2 pasos sin apoyo visual tras 2 minutos",
      "Dificultad para evocar contenido de la sesión anterior sin claves",
      "Errores frecuentes en tareas escolares por olvido de las consignas",
    ],
    ejemploPractico: "Presentar 6 imágenes durante 10 segundos. Cubrir y pedir que nombre las que recuerda (recuerdo libre). Luego dar pistas categóricas para evaluar recuerdo con apoyo. Registrar número en libre vs. asistido. Repetir al inicio de la siguiente sesión para evaluar memoria a largo plazo.",
  },
  "estrategias de aprendizaje": {
    queEvaluar: [
      "Conciencia de las propias dificultades de aprendizaje (metacognición)",
      "Uso espontáneo de estrategias de estudio (repetición, organización, asociación)",
      "Capacidad de planificar y dividir tareas complejas",
      "Evaluación del propio desempeño tras una actividad",
    ],
    comoEvaluarlo: [
      "Entrevista breve: '¿Qué haces cuando no entiendes algo en clase?'",
      "Observación de la tarea: ¿planifica, pide ayuda, abandona o intenta estrategias propias?",
      "Pedir al niño que explique cómo estudia para una prueba",
      "Tarea con error deliberado: observar si el niño lo detecta y cómo lo resuelve",
    ],
    indicadoresClinicos: [
      "Abandona la tarea al primer obstáculo sin intentar estrategias alternativas",
      "No tiene estrategias de estudio definidas; memorizó sin comprensión",
      "No puede identificar qué parte de la tarea le costó más",
      "Sobreestima o subestima significativamente su propio desempeño",
    ],
    ejemploPractico: "Proponer una tarea nueva de dificultad moderada sin instrucciones detalladas. Observar: ¿el niño pregunta, intenta, planifica o abandona? Al finalizar, preguntarle '¿cómo te fue?' y '¿qué harías diferente?' Registrar iniciativa, persistencia y capacidad de autoevaluación.",
  },
};
...
const KEYWORD_AREA_MAP: Array<{ keywords: string[]; area: string }> = [
  ...
  { keywords: ["tdah", "atención", "cognitivo", "dificultades atencionales"], area: "cognición" },
  { keywords: ["funciones ejecutivas", "ejecutivas", "planificación", "inhibición"], area: "funciones ejecutivas" },
  { keywords: ["memoria"], area: "memoria" },
  { keywords: ["dislexia", "dificultades de aprendizaje", "lectura", "lectoescritura"], area: "lectoescritura" },
  { keywords: ["disgrafía"], area: "disgrafía" },
  { keywords: ["producción escrita", "escritura funcional"], area: "producción escrita" },
  { keywords: ["discalculia", "matemática", "cálculo", "número"], area: "matemáticas" },
  { keywords: ["comprensión lectora"], area: "comprensión lectora" },
  { keywords: ["estrategias de aprendizaje", "estrategias"], area: "estrategias de aprendizaje" },
