...
const DIAG_KEYWORDS: Record<string, string[]> = {
  ...
  "cognición":             ["TDAH", "TEA", "atención", "memoria", "ejecutivas", "cognitivo", "aprendizaje", "estrategias", "dificultades atencionales", "funciones ejecutivas"],
  "lectoescritura":        ["dislexia", "lectura", "escritura", "lectoescritura", "disgrafía", "comprensión lectora", "producción escrita", "matemática", "discalculia", "dificultades de aprendizaje"],
